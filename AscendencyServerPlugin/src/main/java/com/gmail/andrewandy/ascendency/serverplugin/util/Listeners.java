...
public class Listeners {
     ...
     */
    @Listener(order = Order.EARLY) public void onEmptyHit(final DamageEntityEvent event) {
     ...
     */
    @Listener(order = Order.EARLY) public void onItemDrop(final DropItemEvent event) {
     ...
     */
    @Listener(order = Order.EARLY) public void onHit(final DamageEntityEvent event) {
