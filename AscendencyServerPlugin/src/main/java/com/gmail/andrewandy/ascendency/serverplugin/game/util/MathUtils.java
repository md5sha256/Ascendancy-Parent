...
public class MathUtils {
     ...
     * @return Returns a collection of blocks within the circle.
     */
    @NotNull public static Collection<Location<World>> createCircleWithCentre(
        @NotNull final Location<World> centre, int radius) {
        if (radius == 0) {
            throw new UnsupportedOperationException();
        }
     ...
     */
    @NotNull public static Collection<Location<World>> createSphereWithCentre(
        @NotNull final Location<World> centre, int radius) {
        if (radius < 0) {
            radius = -radius;
        }
     ...
     */
    @NotNull public static Collection<Location<World>> createSphereWith(
        @NotNull final Location<World> centre, int radius) {
        if (radius < 0) {
            radius = -radius;
        }
