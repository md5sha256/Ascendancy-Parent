...
public class RuneBlessingOfTeleportation extends AbstractRune {
    ...
    @AssistedInject RuneBlessingOfTeleportation(@Assisted final Challenger challenger,
    ...
    @Listener(order = Order.EARLY) public void onMark(final LocationMarkedEvent event) {
