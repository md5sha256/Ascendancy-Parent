package com.gmail.andrewandy.ascendency.serverplugin.game.challenger.bella;
...
public class Bella extends AbstractChallenger {
    ...
    @Inject Bella(@NotNull final BellaComponentFactory componentFactory) {
    ...
    final BellaComponentFactory componentFactory) {
