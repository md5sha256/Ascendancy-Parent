...
import com.gmail.andrewandy.ascendency.serverplugin.game.challenger.astricion.components.RuneDiabolicResistance;
import com.gmail.andrewandy.ascendency.serverplugin.game.challenger.astricion.components.RuneEmpoweringRage;
import com.gmail.andrewandy.ascendency.serverplugin.game.challenger.astricion.components.RuneReleasedLimit;
...
public class Astricion extends AbstractChallenger {
    ...
    @Inject Astricion(@NotNull final PlayerMatchManager matchManager, final AstricionComponentFactory componentFactory) {
    ...
    @Deprecated private static PlayerSpecificRune[] runes(final Challenger challenger) {
