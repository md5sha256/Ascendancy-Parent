...
public class RuneChosenOTEarth extends AbstractRune {
    ...
    @AssistedInject RuneChosenOTEarth(@Assisted final Challenger toBind, AscendencyServerPlugin plugin) {
        super(toBind);
     ...
     */
    @Listener public void onGiftUse(final AbilityLivingGift.LivingGiftUseEvent event) {
