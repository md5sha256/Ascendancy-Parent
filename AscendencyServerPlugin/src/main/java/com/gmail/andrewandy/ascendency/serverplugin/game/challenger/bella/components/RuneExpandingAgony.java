...
public class RuneExpandingAgony extends AbstractRune {
    ...
    @AssistedInject RuneExpandingAgony(@Assisted final AbilityCircletOfTheAccused boundAbility,
    ...
    @Listener public void onProc(final AbilityCircletOfTheAccused.ProcEvent event) {
