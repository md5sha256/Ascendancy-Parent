package com.gmail.andrewandy.ascendency.serverplugin.game.challenger.knavis.components;
...
public class AbilityShadowsRetreat extends AbstractTickableAbility {
    ...
    @AssistedInject AbilityShadowsRetreat(@Assisted final Challenger challenger,
    ...
    @NotNull private LocationMark castAbilityAs(@NotNull final Player player) {
    ...
    @Listener(order = Order.LAST) public void onActiveKeyPress(final ActiveKeyPressedEvent event) {
