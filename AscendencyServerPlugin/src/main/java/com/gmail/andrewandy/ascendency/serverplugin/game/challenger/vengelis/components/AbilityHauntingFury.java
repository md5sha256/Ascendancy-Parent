...
public class AbilityHauntingFury extends AbstractCooldownAbility {
    ...
    @AssistedInject AbilityHauntingFury(@Assisted final Challenger toBind,
    ...
    @Listener(order = Order.DEFAULT) public void onHit(final DamageEntityEvent event) {
        ...
        for (final Player knavis : knavises) {
            ...
            data.addElement((PotionEffect) new BuffEffectFury(1, 0)); //1 Second of fury to all knavises | Safe cast because of mixins.
            knavis.offer(data);
        }
    }
