package com.gmail.andrewandy.ascendency.serverplugin.game.challenger.astricion.components;
...
public final class AbilitySuppression extends AbstractAbility {
    ...
    @AssistedInject public AbilitySuppression(@Assisted final Challenger bound,
